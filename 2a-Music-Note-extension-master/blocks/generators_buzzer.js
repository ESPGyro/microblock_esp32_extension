Blockly.Python['buzzer_pin'] = function(block) {
    Blockly.Python.definitions_['import_buzzer'] = 'import buzzer';
    Blockly.Python.definitions_['from machine import Pin, PWM'] = 'from machine import Pin, PWM';

    var value_pin = Blockly.Python.valueToCode(block, 'pin', Blockly.Python.ORDER_ATOMIC);
    var code = `buzzer.__buzzer = PWM(Pin(${value_pin}), freq=2000, duty=0)\n`;
    return code;
};
