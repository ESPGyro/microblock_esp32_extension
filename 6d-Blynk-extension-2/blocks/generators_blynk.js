Blockly.Python['blynk_setup'] = function(block) {
  ...
  var functionName = Blockly.Python.provideFunction_(
    'blynkSetup',
    ['def ' + Blockly.Python.FUNCTION_NAME_PLACEHOLDER_ + '(auth, debug):',
    '  global blynk',
    '  print("Connecting to Blynk...")',
    '  blynk = BlynkLib.Blynk(auth, server="blynk-cloud.com", log=debug)']);

  var code = `${functionName}(${value_auth}, ${dropdown_debug})\n`;
  return code;
};
